...
########################################################
# Models: Cox Model is used as input to the msfit model
########################################################
...
summary(msf0a)
x11()
plot(msf0a, las=1, lty=rep(1:2, c(8,4)), xlab="Years since transplantation")
...
pt500 <- probtrans(msf0, predt=500/365.25, method="greenwood")
...
ord <- c(2,4,3,5,6,1)
x11()
plot(pt0, from=1, ord=ord, xlab="Years since transplantation",main="predt = 0 days, Start at 1",
		xlim=c(0,10), las=1, type="filled", col=statecols[ord])
x11()
plot(pt100, from=1, ord=ord,xlab="Years since transplantation",main="predt = 100 days, Start at 1",
		xlim=c(0,10), las=1, type="filled", col = statecols[ord])
x11()
plot(pt500, from=1, ord=ord, xlab="Years since transplantation",main="predt = 500 days, Start at 1", 
		xlim=c(0,10), las=1, type="filled", col = statecols[ord])
x11()
plot(pt100,from=3, ord=ord, xlab="Years since transplantation",main="predt = 100 days, Start at 3", 
		xlim=c(0,10),las=1, type="filled", col = statecols[ord])
x11()
par(mfrow=c(1,2))
plot(pt100,ord=ord,xlab="Years since transplantation",main="Starting from transplant", 
		xlim=c(0,10),las=1, type = "filled", col = statecols[ord])
plot(pt100,from=3,ord=ord,xlab="Years since transplantation",main="Starting from AE",
		xlim=c(0,10), las=1, type = "filled", col = statecols[ord])
par(mfrow=c(1,1))
...
########################################################
# Models: Cox Model is used as input to the msfit model
# here it is fit with covariates
########################################################
...
whB <- which(msebmt$proph=="no" & msebmt$match=="gender mismatch" & msebmt$year=="1985-1989" & msebmt$agecl==">40")
